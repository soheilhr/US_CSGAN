...
#        d1 = d_layer(combined_imgs, self.df, bn=False)
    ...
    def train(self, epochs, batch_size=1, save_interval=50):
        ...
        for epoch in range(epochs):
            ...
            print ("%d [D loss: %f, acc.: %.2f%%] [G loss: %f]" % (epoch, d_loss[0], 100*d_loss[1], g_loss[0]/100))
...
#    if CPU:
    ...
    gan = CSGAN()
    gan.load_model('C:\\Users\\sohei_000\\pgan\\','model1')
    gan.train(epochs=1000, batch_size=32, save_interval=10)
    gan.save_model('C:\\Users\\sohei_000\\pgan\\','model2')
